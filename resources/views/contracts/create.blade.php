...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6 form-group">
            {{ Form::label('echelle', __('Echelle'),['class'=>'col-form-label']) }}
            {{ Form::number('echelle', '', array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="col-md-6 form-group">
            {{ Form::label('indice', __('Indice'),['class'=>'col-form-label']) }}
            {{ Form::number('indice', '', array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group">
            {{ Form::label('grade', __('Grade'),['class'=>'col-form-label']) }}
            {{ Form::text('grade', '', array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="col-md-6 form-group">
