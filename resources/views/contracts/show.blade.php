                                        ...
                                        <div class="card-body pt-0 ">
                                            <address class="mb-0 text-sm">
                                                <div class="row mt-3 align-items-center">
                                                    ...
                                                    <div class="col-sm-4 h6 text-sm">{{ __('Echelle') }}</div>
                                                    <div class="col-sm-8 text-sm"> {{ $contract->echelle }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Indice') }}</div>
                                                    <div class="col-sm-8 text-sm"> {{ $contract->indice }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Grade') }}</div>
                                                    <div class="col-sm-8 text-sm"> {{ $contract->grade }}</div>
