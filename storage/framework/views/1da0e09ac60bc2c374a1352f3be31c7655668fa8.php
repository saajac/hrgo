                                        ...
                                        <div class="d-flex radio-check">
                                            <div class="custom-control custom-radio custom-control-inline" style="margin-right: 15px;">
                                                <input type="radio" id="single" value="Célibataire" name="etatcivil"
                                                    class="form-check-input"
                                                    <?php echo e($employee->etatcivil == 'Célibataire' ? 'checked' : ''); ?>>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::number('account_number', null, ['class' => 'form-control'])); ?>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('bank_name', $banks, $banks[$current_bank], ['class' => 'form-control ', 'placeholder' => 'Selectionner une banque'])); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('bank_name', $banks, $banks[$employee->bank_name], ['class' => 'form-control ', 'placeholder' => 'Selectionner une banque'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medeni/dev/hypercube/hrmgo/resources/views/employee/edit.blade.php ENDPATH**/ ?>