                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $saturationdeductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saturationdeduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <?php if($saturationdeduction->title != 'Mont Impôt'): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medeni/dev/hypercube/hrmgo/resources/views/setsalary/employee_salary.blade.php ENDPATH**/ ?>