...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6 form-group">
            ...
            <?php echo e(Form::number('echelle', '', array('class' => 'form-control','required'=>'required'))); ?>

        </div>
        <div class="col-md-6 form-group">
            <?php echo e(Form::label('indice', __('Indice'),['class'=>'col-form-label'])); ?>

            <?php echo e(Form::number('indice', '', array('class' => 'form-control','required'=>'required'))); ?>

        </div>
        <div class="form-group">
            <?php echo e(Form::label('grade', __('Grade'),['class'=>'col-form-label'])); ?>

            <?php echo e(Form::text('grade', '', array('class' => 'form-control','required'=>'required'))); ?>
...
</script><?php /**PATH /home/medeni/dev/hypercube/hrgo/resources/views/contracts/create.blade.php ENDPATH**/ ?>