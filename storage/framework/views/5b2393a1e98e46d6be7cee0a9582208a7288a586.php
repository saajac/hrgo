                    ...
                    <div class="card">
                        <div class="card-body employee-detail-body fulls-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('Matricule')); ?> :</strong>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medeni/dev/hypercube/hrgo/resources/views/employee/show.blade.php ENDPATH**/ ?>