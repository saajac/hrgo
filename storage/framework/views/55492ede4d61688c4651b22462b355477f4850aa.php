                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::number('phone', old('phone'), ['class' => 'form-control', 'placeholder' => 'Enter employee Phone']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/medeni/dev/hypercube/hrmgo/resources/views/employee/create.blade.php ENDPATH**/ ?>