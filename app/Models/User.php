...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function priceFormat($price)
    {
        ...
        return (($settings['site_currency_symbol_position'] == "pre") ? number_format($price, 2) . $settings['site_currency_symbol'] : '') .(($settings['site_currency_symbol_position'] == "post") ? $settings['site_currency_symbol'] : '');
    }
